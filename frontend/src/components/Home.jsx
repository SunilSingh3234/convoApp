    ...
    const handleSubmit=async(event)=>{
        ...
        try {
           const response =await axios.post("http://localhost:3000/convertFile",formData,{
            ...
            link.href=url;
            console.log(link)
            link.setAttribute("download",selectedFile.name.replave(/\.[^/.]+$/,"")+".pdf")
            console.log(link)
    ...
    <div className="max-w-screen-2xl mx-auto container px-6 py-3 md:px-40"> 
        <div className='flex h-screen items-center justify-center'>
            <div className='border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg'>
                ...
                <p className='text-sm mb-5 text-center'>Easy convert word to PDF format online, without install any software.</p>
            ...
            <div className='flex flex-col items-center space-y-4'>
                ...
                disabled={!selectedFile} className=' text-white bg-blue-500 disabled:bg-gray-400 disabled:pointer-events-none hover:bg-blue-700 duration-300 font-bold px-4 py-2 rounded-lg'>Convert File</button>
